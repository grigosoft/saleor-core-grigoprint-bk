...
from ..models import Personalizzazione

def calcola_prezzo_prodotto_personalizzato(personalizzazione:Personalizzazione):
...
def calcola_prezzo_prodotto_bandiera_personalizzata(personalizzazione:Personalizzazione):
    "ciao"